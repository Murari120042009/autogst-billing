...
const invoicePdf_1 = require("../services/invoicePdf");
 ...
 */
router.post("/:invoiceId/correct", (0, requirePermission_1.requirePermission)("invoice.edit"), async (req, res) => {
    try {
        ...
        const pdfBytes = await (0, invoicePdf_1.generateInvoicePDF)(correctedData);
        // 2️⃣ Upload PDF to MinIO
        const pdfUrl = await (0, minio_1.uploadBufferToMinio)({
            bucketName: "invoices",
